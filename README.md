...
- `Ctrl+Shift+P` &Rarr; Dev Containers: ReOpen Folder in Container
...
- Install [Resource Monitor](https://marketplace.visualstudio.com/items?itemName=mutantdino.resourcemonitor) inside the devcontainer to track the % of the resources being consumed by the devcontainer.
